    ...
    try {
      ...
      for (const variant of variants) {
        if (
          ...
          message.error(
            "Tất cả các trường của phiên bản phải được điền đầy đủ."
          );
          return;
        }
      }
            ...
            <TabPane tab="Thông tin cơ bản" key="1">
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Vui lòng nhập thông tin màn hình",
                  },
                ]}
              >
                <Input />
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Vui lòng nhập thông tin chip xử lý",
                  },
                ]}
              >
                <Input />
              ...
              <Form.Item
                ...
                label="RAM"
                rules={[
                  { required: true, message: "Vui lòng nhập thông tin RAM" },
                ]}
              >
                <Input />
              </Form.Item>
              ...
              <Form.Item
                ...
                label="Camera"
                rules={[
                  { required: true, message: "Vui lòng nhập thông tin camera" },
                ]}
              >
                <TextArea
                  rows={1}
              ...
              <Form.Item
                ...
                label="Pin"
                rules={[
                  { required: true, message: "Vui lòng nhập thông tin pin" },
                ]}
              >
                <Input />
              </Form.Item>
                  ...
                  <Space direction="vertical" style={{ width: "100%" }}>
                    ...
                    <Form.Item label="Giá khuyến mãi">
                      <InputNumber
                        ...
                        onChange={(value) =>
                          handleVariantChange(index, "discount_price", value)
                        }
                        formatter={(value) =>
                          `${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                        }
                    ...
                    <Form.Item label="Hình ảnh">
                      <Upload
                        ...
                        showUploadList={false}
                        beforeUpload={(file) =>
                          handleVariantImageUpload(file, index)
                        }
                        accept="image/*"
